    ...
    [
      {
        ...
        status: 'TODO', priority: 'HIGH', dueDate: '2026-04-01',
      ...
      },
      {
        ...
        status: 'TODO', priority: 'MEDIUM', dueDate: '2026-04-05',
      ...
      },
      {
        ...
        status: 'DOING', priority: 'HIGH', dueDate: '2026-03-25',
        assignee: { uid: 'u-1', displayName: 'Alice Johnson' },
      ...
      },
      {
        ...
        status: 'DOING', priority: 'LOW', dueDate: null,
      ...
      },
      {
        ...
        status: 'DOING', priority: 'MEDIUM', dueDate: '2026-03-28',
        assignee: { uid: 'u-2', displayName: 'Bob Smith' },
      ...
      },
      {
        ...
        status: 'DONE', priority: 'HIGH', dueDate: '2026-03-10',
        assignee: { uid: 'u-3', displayName: 'Carol White' },
      ...
      },
      {
        ...
        status: 'DONE', priority: 'MEDIUM', dueDate: '2026-03-12',
        assignee: { uid: 'u-1', displayName: 'Alice Johnson' },
      ...
      },
      {
        ...
        status: 'DONE', priority: 'LOW', dueDate: null,
        assignee: { uid: 'u-2', displayName: 'Bob Smith' },
